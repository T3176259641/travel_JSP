...
<html>
	...
	<jsp:useBean id="resultBean" class="mybean.data.user_enrol" scope="request"></jsp:useBean>
	<body>
		<!-- 头部部分 -->
		<header>
		...
		<!-- 登录/注册显示部分 -->
		<div class="content-wrapper show_er">
			<section id="go-on" class="showcases section-bg section-bg02">
				<h2 style="font-size: 30px" id="userName"> 
				<%
					String[][] record = resultBean.getTableRecord();
					for(int i=0;i<record.length;i++){
						for(int j=0;j<record[i].length;j++){
							out.print("欢迎回来 - "+record[i][j]);
						}
					}
				%>
				</h2>
		...
		<div class="content-wrapper show">
			<div class="show">
				<p style="font-size: 30px;padding-top: 15px;">登陆失败！<br>
					<a class="explore-btn02" href="index.jsp" style="text-decoration: none;">重新登录</a>
				</p>		
			</div>
		</div>
		<!-- 内容主体部分 -->
		<div class="content-wrapper">
			<section id="travel_recomment" class="showcases section-bg">
				...
				<div class="filter-btns">
					...
					<a class="filter-btn very-goon" href="更多.jsp" target="_blank" >更多</a>
				</div>
				<div class="cases">
					<div class="case-item zhanjiang">
						...
						<div class="well_tx">
							...
							<a href="更多.jsp#travel_recomment" target="_blank" >点击此处了解 ></a>
						</div>
					</div>
			...
			<section id="travel_dynamic" class="company-activities">
				...
				<div class="activities">
					<div class="activity">
						...
						<button class="read-more-btn"><a href="table_bm.jsp#user" target="_blank" style="text-decoration: none;color: white;">立即报名</a></button>
					</div>
					<div class="activity">
						<div class="act-image-wrapper">
